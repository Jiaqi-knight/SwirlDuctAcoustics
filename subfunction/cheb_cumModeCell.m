...
for kkk=1:lx
    ...
    for kk=1:length(Gw)
         %Pww{1,kkk}=Pww{1,kkk}+Pw{1,kk}{1,kkk};%对k积分
         Gww{1,kkk}=Gww{1,kkk}+Gw{1,kk}{1,kkk};%对k积分
         Tmm1{1,kkk}=Tmm1{1,kkk}+Tm1{1,kk}{1,kkk};%对k积分
         Tmm2{1,kkk}=Tmm2{1,kkk}+Tm2{1,kk}{1,kkk};%对k积分
         Tmm3{1,kkk}=Tmm3{1,kkk}+Tm3{1,kk}{1,kkk};%对k积分
    end
         %PPw(:,:,kkk)=Pww{1,kkk}(r);
         GGw(:,:,kkk)=Gww{1,kkk}(r);
